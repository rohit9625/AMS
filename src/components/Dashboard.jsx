...
export default function Dashboard({students, enrollmentOptions}) {
  ...
  const sampleTeachers = [
    {
      ...
      name: "John Doe",
      age: 21,
      profile: "https://placekitten.com/100/100", // Replace with actual profile image URL
      department: "Mathematics",
      email: "rv17837@gmail.com",
      userID: "rohit001",
      password: "asdlkjf0",
    },
    {
      id: 2,
      name: "Jane Smith",
      profile: "https://placekitten.com/100/101", // Replace with actual profile image URL
      department: "Science",
    },
    ...
    <div className="bg-gray-200 w-full py-4 px-8 flex-1">
      <div className="bg-white space-y-2 rounded-lg h-full px-0 relative shadow-2xl">
        ...
        {activeSection == "faculties" ? (
          <Teachers activeSection={activeSection} teachers={sampleTeachers} />
        ) : (
          <Students activeSection={activeSection} students={students} />
        )}
      </div>
    </div>
  );
